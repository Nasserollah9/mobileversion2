...
public class CascadeClassifier {
    ...
    public void detectMultiScale(Mat gray, MatOfRect faces, double scaleFactor, int minNeighbors, int cascadeScaleImage, android.util.Size size, android.util.Size size1) {
    }
}
