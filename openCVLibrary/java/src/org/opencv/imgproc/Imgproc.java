...
private static native double[] n_getTextSize(String text, int fontFace, double fontScale, int thickness, int[] baseLine);
    ...
    public static void GaussianBlur(Mat gray, Mat gray1, android.util.Size size, int sigmaX) {
    }

    public static void detectMultiScale(Mat gray, MatOfRect faces, double v, int i, int cascadeScaleImage, android.util.Size size, android.util.Size size1) {
    }
}
